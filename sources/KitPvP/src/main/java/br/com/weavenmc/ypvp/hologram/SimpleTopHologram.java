package br.com.weavenmc.ypvp.hologram;
...
public class SimpleTopHologram {
	...
	public void spawn() {
		...
		}.runTaskAsynchronously(yPvP.getPlugin());

		Bukkit.getScheduler().runTaskTimerAsynchronously(yPvP.getPlugin(), new RunnableHologramUpdater(), update, update);
	}
